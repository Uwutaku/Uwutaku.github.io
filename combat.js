...
var battleNames = ["Абукир", "Абенсберг", "Акра", "Альба-де-Тормес", "Ла-Альбуэра", "Бухта Альхесирас", "Амштеттен", "Арси-сюр-Об", "Асперн-Эсслинг", "Йена-Аверштедт", "Арколь", "Аустерлиц", "Бадахос", "Байлен", "Ла Барроса", "Бассано", "Баутцен", "Березина", "Бергизель", "Бородино", "Бургос", "Бусако", "Кадис", "Кальдьеро", "Кастильоне", "Каслбар", "Шампобер", "Шато-Тьерри", "Копенгаген", "Корунья", "Крон", "Дего", "Деневиц", "Дрезден", "Дюренштайн", "Эккмюль", "Эльхинген", "Эспиноза-де-лос-Монтерос", "Эйлау", "Мыс Финистер", "Фридланд", "Фуэнтес-де-Оноро", "Река Гевора", "Жирона", "Гамбург", "Хаслах-Юнгинген", "Хайльсберг", "Хоэнлинден", "Йена-Аверштедт", "Кайхона", "Кольберг", "Ландсхут", "Лейпциг", "Линьи", "Лоди", "Любек", "Лютцен", "Маренго", "Мария", "Медельин", "Медина-де-Риосеко", "Мильезимо", "Река Минцио", "Мондови", "Монтебелло", "Монтенотте", "Монмираль", "Гора Тавор", "Река Нил", "Нови", "Окана", "Мыс Ортегаль", "Орте", "Панкорбо", "Река Пьяве", "Пирамиды", "Катр-Брас", "Раб", "Рашин", "Риволи", "Ролика", "Ла-Ротьер", "Роверето", "Зальфельд", "Шонграберн", "Саламанка", "Смоленск", "Сомосьерра", "Талавера", "Тамамес", "Трафальгар", "Треббия", "Тудела", "Ульм", "Вальс", "Вальмаседа", "Валутино", "Вошан", "Вимейро", "Витория", "Ваграм", "Ватерлоо", "Вавр", "Вертинген", "Сарагоса"];
...
function createBattle(){
    ...
    battleName = ("Атака дрифтеров "+newBattle.id);
